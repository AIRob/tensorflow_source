# -*- coding: utf-8 -*-
"""
Created on Thu Jun 28 09:51:55 2018
...
def generateData():
    x = np.array(np.random.choice(2,total_series_length,p=[0.5,0.5]))   #在 0， 1 选择total_series_length 个数
    y = np.roll(x,echo_step)    #向右循环移位，将 [1111000] 变为 [00011111]
    y[0:echo_step] = 0
...
#将batchX_palaceHolder 沿着维度为 1  的轴方向 进行拆分
