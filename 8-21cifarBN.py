# -*- coding: utf-8 -*-
"""
Created on Wed Jun 27 14:31:33 2018
...
train = tf.placeholder(tf.float32)  #为 BN 函数 添加占位符参数
...
h_conv3 = tf.nn.relu(batch_norm_layer((conv2d(h_pool2,W_conv3) + b_conv3),train))
